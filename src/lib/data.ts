...
export const destinations: DestinationData[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    heroImage:
      'https://images.unsplash.com/photo-1572883454114-1cf0031ede2a?auto=format&fit=crop&w=1600&q=80',
    gallery: [
      'https://images.unsplash.com/photo-1572883454114-1cf0031ede2a?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1606298855672-3efb63017be8?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1566837945700-30057527ade0?auto=format&fit=crop&w=1200&q=80',
  ...
  // === NEW KASHMIR DESTINATIONS ===
  {
    ...
    latitude: 34.0667,
    longitude: 74.4333,
    tagline: 'Kashmir\'s Only Frozen Waterfall',
    description:
      'Drung is a small village near Tangmarg, just 30km from Gulmarg, home to a stunning waterfall that freezes solid in winter and gushes crystal-clear all summer. A short walk from the road, the Drung waterfall has become one of Kashmir\'s most Instagrammed spots - especially in January when the entire cliff face turns into a wall of ice. The village itself is postcard-pretty, with wooden houses, terraced fields and a serene river running through it. Day trips combine perfectly with Gulmarg.',
    bestTime: 'October to March for frozen falls; April to June for gushing water',
    duration: '1 day',
    difficulty: 'Easy',
    rating: 4.6,
    heroImage: 'https://images.unsplash.com/photo-1547036967-23d11aacaee0?auto=format&fit=crop&w=1600&q=80',
    gallery: [
      'https://images.unsplash.com/photo-1547036967-23d11aacaee0?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1547036967-23d11aacaee0?auto=format&fit=crop&w=1200&q=80',
    ...
    attractions: [
      'Frozen waterfall (Jan-Feb)',
      'Tangmarg market',
      'Ferozepur Nallah river',
      'Local Kashmiri village walk',
      'Apple orchards (Sep-Oct harvest)',
    ],
    activities: [
      'Photography of frozen falls',
      'Short nature walks',
      'Kahwa with local families',
      'Combined day trip with Gulmarg',
      'Apple picking in autumn',
    ],
    howToReach:
      '30km from Gulmarg, 50km from Srinagar (1.5 hours). Reach Tangmarg on the Srinagar-Gulmarg road, then 3km to Drung village. Cabs available from Srinagar and Gulmarg.',
    featured: false,
  },
  {
    slug: 'bangus-valley',
    ...
    latitude: 34.5,
    longitude: 74.0,
    tagline: 'The Hidden Green Bowl of Kupwara',
    description:
      'Bangus is one of Kashmir\'s least-explored alpine meadows - a 5km-long green bowl ringed by pine forest in the Kupwara district, near the Line of Control. Two valleys - Bodh Bangus (big) and Lakut Bangus (small) - are home to wildflowers, Himalayan black bears, and nomadic Gujjar families in summer. The drive from Srinagar is long (4 hours) but the reward is absolute solitude in a meadow more pristine than Pahalgam or Yusmarg. Permits are required and best arranged through us.',
    bestTime: 'May to September (peak bloom: June-July)',
    duration: '2-3 days',
    difficulty: 'Challenging',
    rating: 4.7,
    ...
    attractions: [
      'Bodh Bangus (large meadow)',
      'Lakut Bangus (small meadow)',
      'Gujjar nomad camps',
      'Himalayan black bear habitat',
      'Wildflower blooms (June-July)',
    ],
    activities: [
      'Multi-day camping trek',
    ...
    howToReach:
      '90km from Srinagar via Kupwara (4 hours). Inner Line Permit required - arranged by us. Last motorable point: Chowkibal, from where 6km trek to the meadow.',
    featured: false,
  },
  {
    slug: 'kokernag',
    ...
    latitude: 33.5667,
    longitude: 75.2167,
    tagline: 'The Spring of Springs',
    description:
      'Kokernag is a garden town built around a fresh-water spring that splits into a network of channels shaped like the claws of a rooster (koker = rooster, nag = spring). The Botanical Garden here, with its manicured lawns, trout streams and rose beds, is one of the prettiest in Kashmir. The spring water is so clear that the bottom - 15m below - looks just an arm\'s length away. It\'s an ideal day stop between Srinagar and Sinthan Top.',
    bestTime: 'April to October',
    duration: '1 day',
    difficulty: 'Easy',
    rating: 4.4,
    ...
    attractions: [
      'Kokernag Spring (the "claw" channels)',
      'Botanical Garden',
      'Trout fish farm',
      'Rose garden',
      'Papashahi canal',
    ...
    activities: [
      'Garden walks & picnics',
      'Trout fishing (permit required)',
      'Photography',
      'Day trip from Srinagar or Pahalgam',
    ],
    howToReach:
      '75km from Srinagar (2 hours) via Anantnag. Cabs available. Often combined with Sinthan Top and Daksum as a day circuit.',
    featured: false,
  },
  {
    slug: 'verinag',
    ...
    description:
      'Verinag is the source of the Jhelum (Vitasta) river, the lifeline of Kashmir. An octagonal Mughal spring pavilion, built by Jahangir in 1620, sits at the head of a deep blue spring from which the river emerges. Surrounded by chinar and pine, it is one of the most peaceful Mughal monuments in the valley - and the starting point of the historic Mughal Road to Poonch. Shah Jahan\'s garden here is smaller than Srinagar\'s but rarely crowded.',
    bestTime: 'April to October',
    duration: '1 day',
    difficulty: 'Easy',
    rating: 4.4,
    ...
    attractions: [
      'Octagonal spring pavilion (Jahangir, 1620)',
      'Source of the Jhelum river',
      'Mughal Garden',
      'Mughal Road starting point',
      'Shah Jahan\'s shade pavilions',
    ],
    activities: [
      'Walk around the spring',
      'Photography',
      'Begin the Mughal Road journey',
      'Picnic in Mughal garden',
    ],
    howToReach:
      '80km from Srinagar (2 hours) on the road to Anantnag. Often visited en route to Kokernag, Sinthan Top, or the Mughal Road.',
    featured: false,
  },
  {
    slug: 'achabal',
    ...
    latitude: 33.6833,
    longitude: 75.3000,
    tagline: 'Mughal Garden of the Princess',
    description:
      'Achabal is a Mughal garden built around a sacred spring, attributed to Nur Jahan (wife of Jahangir) and known locally as "the garden of the princess". A series of cascading chutes, fountains and cypress-lined terraces fall from the spring at the top of the garden down to a fish-filled tank below. It is the most atmospheric of the lesser-known Mughal gardens - quiet, shaded and beautifully preserved.',
    bestTime: 'April to October',
    duration: '1 day',
    difficulty: 'Easy',
    rating: 4.3,
    ...
    attractions: [
      'Mughal Garden (Nur Jahan era)',
      'Spring-fed cascades',
      'Fish pond (panoramic view)',
      'Cypress grove',
      'Saffron fields nearby',
    ],
    activities: [
      'Garden walks',
      'Photography',
      'Visit nearby Verinag & Kokernag',
      'Saffron field stops (autumn)',
    ],
    howToReach:
      '8km from Anantnag, 75km from Srinagar (2 hours). Best combined as a day circuit with Kokernag, Verinag and Sinthan Top.',
    featured: false,
  },
  {
    slug: 'daksum',
    ...
    latitude: 33.5833,
    longitude: 75.4167,
    tagline: 'Pine Forest Hideaway',
    description:
      'Daksum is a quiet forest settlement on the road to Sinthan Top, surrounded by dense pine forest and the rushing Bringi river famous for trout. Long favoured by British anglers in the 19th century, it remains a contemplative spot for those who want to be deep in the forest without climbing to alpine altitudes. Pony rides, forest walks and trout fishing are the main draws.',
    bestTime: 'May to October',
    duration: '1-2 days',
    difficulty: 'Easy',
    rating: 4.5,
    ...
    howToReach:
      '85km from Srinagar (2.5 hours) via Anantnag. On the road to Sinthan Top. Combine with Kokernag and Verinag as a day circuit.',
    featured: false,
  },
  {
    slug: 'sinthan-top',
    ...
    latitude: 33.5667,
    longitude: 75.5000,
    tagline: 'The Snow Pass Above Anantnag',
    description:
      'Sinthan Top is a 3,810m high mountain pass on the Anantnag-Kishtwar road, often compared to Zoji La for its dramatic scenery. Snow remains on the pass until July, and the views stretch all the way to the Pir Panjal. Below the pass lie the alpine meadows of Margan Top and the turquoise Sinthan Lake. The road from Daksum climbs through dense forest to the treeless summit - one of the most spectacular drives in Kashmir.',
    bestTime: 'June to October (closed Nov-May due to snow)',
    duration: '1 day',
    difficulty: 'Moderate',
    rating: 4.7,
    heroImage: 'https://images.unsplash.com/photo-1606298855672-3efb63017be8?auto=format&fit=crop&w=1600&q=80',
    gallery: [
      'https://images.unsplash.com/photo-1606298855672-3efb63017be8?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1583417319070-4a69db38a482?auto=format&fit=crop&w=1200&q=80',
      'https://images.unsplash.com/photo-1559128010-7c1ad6e1b6a5?auto=format&fit=crop&w=1200&q=80',
    ...
    attractions: [
      'Sinthan Top pass (3,810m)',
      'Sinthan Lake (alpine, turquoise)',
      'Margan Top meadow',
      'Snow walls (June)',
      'Kishtwar road views',
    ],
    activities: [
      'Snow photography',
      'Short walks at the pass',
      'Day trip from Srinagar or Daksum',
      'Drive through alpine meadow',
    ],
    howToReach:
      '100km from Srinagar (3 hours) via Anantnag and Daksum. Road closes November-May due to snow. Permit sometimes required - check with us.',
    featured: false,
  },
  {
    slug: 'tosa-maidan',
    ...
    latitude: 33.85,
    longitude: 74.65,
    tagline: 'The Largest Meadow of Kashmir',
    description:
      'Tosa Maidan is a vast alpine meadow - the largest in Kashmir - located in the Pir Panjal range near Yusmarg. Until 2013 it was an artillery firing range; now it has been opened for tourism and is one of the most untouched meadows in the valley. Day walks lead to lakes and shepherd camps. For travellers who have already seen Pahalgam and Sonmarg, Tosa Maidan is the next-level meadow experience.',
    bestTime: 'May to September',
    duration: '1-2 days',
    difficulty: 'Moderate',
    rating: 4.7,
    ...
    attractions: [
      'Vast alpine meadow (3km x 1.5km)',
      'Sukh Sarai lake (4km walk)',
      'Pir Panjal peaks',
      'Shepherd camps (Bakarwals)',
      'Nilnag Lake nearby',
    ],
    activities: [
      'Meadow trekking',
      'Pony rides',
      'Camping',
      'Shepherd culture interaction',
      'Photography',
    ],
    howToReach:
      '50km from Srinagar (2 hours) via Budgam and Khag. Best combined with Yusmarg as a 2-day trip. Inner Line Permit sometimes required - check with us.',
    featured: false,
  },
  {
    slug: 'lolab-valley',
    ...
    latitude: 34.55,
    longitude: 74.35,
    tagline: 'The Valley of Love & Legends',
    description:
      'Lolab (locally "Lulab", meaning the valley of love) is a fertile bowl in Kupwara district, dotted with rice paddies, apple orchards and freshwater springs. It is mentioned in the Rajatarangini, Kashmir\'s 12th-century chronicle, and is said to be the home of the legendary queen Lolla. The valley has three sub-valleys - Kalaroos, Sogam and Warnow - each with its own spring and charm. Far off the standard tourist map, Lolab rewards travellers with the slowest, most authentic Kashmiri rural experience available.',
    bestTime: 'April to October',
    duration: '2-3 days',
    difficulty: 'Moderate',
    rating: 4.6,
    ...
    attractions: [
      'Lolab spring (Satu Sir)',
      'Kalaroos caves (mythological)',
      'Sogam meadow',
      'Warnow river',
      'Bakarwal nomad camps in summer',
    ],
    activities: [
      'Village walks',
      'Apple orchard visits (Sep)',
      'Spring visits',
      'River-side picnics',
      'Heritage & legends tour',
    ],
    howToReach:
      '120km from Srinagar (4 hours) via Kupwara. Cabs available but limited. Best arranged through us with an overnight in Kupwara.',
    featured: false,
  },
  {
    slug: 'gurez',
    ...
    latitude: 34.5833,
    longitude: 75.1167,
    tagline: 'The Last Village Before the Line of Control',
    description:
      'Gurez is a remote trans-Himalayan valley north of Bandipora, on the road toward the Line of Control and the ancient Silk Route to Gilgit. Habited by the Dard-Shina people who speak a unique language and have their own folklore, Gurez is one of the most culturally distinct regions of Kashmir. The road in - over the Razdan Pass at 3,300m - is itself a destination. Below lies the turquoise Kishanganga river, alpine meadows at Tilel, and the famously welcoming Dard-Shina villages.',
    bestTime: 'June to September',
    duration: '4-5 days',
    difficulty: 'Challenging',
    rating: 4.8,
    ...
    attractions: [
      'Razdan Pass (3,300m)',
      'Tilel Valley (alpine meadows)',
      'Kishanganga river',
      'Dard-Shina villages (Dawar, Tilel, Chorwan)',
      'Habba Khatoon peak (named after the poetess)',
    ],
    activities: [
      'Dard-Shina cultural immersion',
      'Multi-day jeep safari',
      'River rafting (Kishanganga)',
      'Trek to Tilel meadow',
      'Stargazing',
    ],
    howToReach:
      '150km from Srinagar (5-6 hours) via Bandipora and Razdan Pass. Road open June-September only. Inner Line Permit required - arranged by us.',
    featured: false,
  },
  {
    slug: 'araku-gulmarg-backcountry',
    name: 'Khilanmarg',
    region: 'Kashmir',
    state: 'Jammu & Kashmir',
    elevation: 3050,
    latitude: 34.05,
    longitude: 74.42,
    tagline: 'The Meadow Above Gulmarg',
    description:
      'Khilanmarg is a small alpine meadow 5km above Gulmarg at 3,050m, offering unobstructed views of the twin peaks of Nun Kun and the Affarwat massif. In spring (April-May) the meadow blooms with daisies, in summer it is a green bowl dotted with ponies, and in winter it is a powdery ski run accessible by gondola. Khilanmarg is best as a half-day extension to Gulmarg itself - perfect for photography, picnics, and a moment of silence away from Gulmarg\'s crowds.',
    bestTime: 'April to October (peak bloom April-May)',
    duration: '1 day',
    difficulty: 'Easy',
    rating: 4.5,
    ...
    attractions: [
      'Alpine meadow at 3,050m',
      'Panoramic Himalayan views',
      'Nun Kun peak visibility',
      'Apple orchards en route',
      'Gondola mid-station Kongdoori',
    ],
    activities: [
      'Pony ride from Gulmarg (5km)',
      'Short trek',
      'Photography',
      'Picnic',
    ...
    howToReach:
      '5km from Gulmarg. Pony ride or walk. Sometimes accessible via gondola mid-station. Day trip from Gulmarg hotels.',
    featured: false,
  },
  {
    slug: 'chatpal',
    ...
    latitude: 33.7,
    longitude: 75.3667,
    tagline: 'The Undiscovered Pahalgam',
    description:
      'Chatpal is a tiny meadow-and-pine village in the Anantnag district, 25km beyond Pahalgam on the road to Sinthan Top. Often called "the Pahalgam of the 1960s", it sees barely a dozen travellers a week. The meadow is ringed by pine and deodar forest, with the Bringi river running through and trout in its streams. There is a single Forest Rest House, a couple of homestays, and that\'s it. For travellers who want absolute silence, this is it.',
    bestTime: 'May to October',
    duration: '1-2 days',
    difficulty: 'Easy',
    rating: 4.6,
    ...
    attractions: [
      'Untouched pine meadow',
      'Bringi river trout beats',
      'Forest Rest House (colonial era)',
      'Sinthan Top road views',
      'Mountain silence',
    ],
    activities: [
      'Forest walks',
      'Trout fishing',
      'Picnics',
      'Forest rest house overnight',
      'Stargazing',
    ],
    howToReach:
      '100km from Srinagar (3 hours) via Anantnag and Pahalgam. Limited homestays - book through us in advance.',
    featured: false,
  },
  {
    slug: 'watlab',
    ...
    latitude: 34.2,
    longitude: 74.5333,
    tagline: 'Apple Orchards & Saffron Fields',
    description:
      'Watlab is a quiet village in Baramulla district, 50km from Srinagar, known for its vast apple orchards, saffron fields and the shrine of Syed Abdullah Andrabi. The Orchards & Cottage Trail run by Kashmir\'s Tourism Department passes through here. In September the apple harvest begins and the air smells of ripening fruit; in October the saffron blooms purple. Homestays are available in traditional Kashmiri wooden houses.',
    bestTime: 'September to November (apple harvest & saffron bloom)',
    duration: '1-2 days',
    difficulty: 'Easy',
    rating: 4.4,
    heroImage: 'https://images.unsplash.com/photo-1547036967-23d11aacaee0?auto=format&fit=crop&w=1600&q=80',
    ...
    attractions: [
      'Apple orchards (September harvest)',
      'Saffron fields (October bloom)',
      'Syed Abdullah Andrabi shrine',
      'Walnut groves',
      'Traditional Kashmiri wooden houses',
    ],
    activities: [
      'Apple picking (Sep)',
      'Saffron harvest experience (Oct)',
      'Homestay experience',
      'Kashmiri cooking class',
      'Village walks',
    ],
    howToReach:
      '50km from Srinagar (1.5 hours) via Baramulla. Best via private cab. Limited homestays - book through us.',
    featured: false,
  },
]
